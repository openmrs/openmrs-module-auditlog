...
/**
 * AUDIT-40: REST endpoint returning the total count of audit log entries matching the given
 * filters, without pagination overhead.
 *
...
public class AuditLogCountController {
	...
	public ResponseEntity<?> countAuditLogs(
		...
		long count = Context.getService(AuditLogService.class)
		        .countAuditLogs(null, actions, startDate, endDate, true);
